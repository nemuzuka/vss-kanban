...
export default class Utils {
  ...
  static escapeTextArea(org) {
    ...
    ret = ret.replace(re, '<a href="$1" class="link" target="_blank" rel="noopener noreferrer" onClick="if(event.stopPropagation){event.stopPropagation();}event.cancelBubble=true;">$1</a> ');
    return ret;
  }
